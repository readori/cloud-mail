const en = {
    ...
    cc: 'Cc',
    bcc: 'Bcc',
    invalidRecipientMsg: 'Invalid email address: {email}',
    recipientLimitMsg: 'The total number of To, Cc, and Bcc recipients cannot exceed 100.',
    delivered: 'Delivered',
    ...
    syncDeleteDesc: 'Permanently delete mail, secondary addresses, and users instead of using the audited retention window.',
    syncDeleteConfirm: 'Enable permanent deletion? Deleted data will bypass the trash retention period and cannot be restored.',
    ...
    aiPrivacyDisclosure: 'When enabled, Cloudflare Workers AI receives the message subject and up to 6,000 characters of body text only for matching senders/domains. Keep this disabled unless you accept that processing path.',
    oss: 'Object Storage',
    osDomain: 'Domain',
