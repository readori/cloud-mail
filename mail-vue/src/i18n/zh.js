const zh = {
    ...
    cc: '抄送',
    bcc: '密送',
    invalidRecipientMsg: '邮箱地址格式无效：{email}',
    recipientLimitMsg: '收件人、抄送和密送总数不能超过 100 个。',
    delivered: '发送成功',
    complained: '被标记为垃圾',
    delayed: '发送被延迟',
    bounced: '发送失败',
    ...
    loginDomain: '隐藏登录域名',
    syncDelete: '同步删除',
    syncDeleteDesc: '开启后邮件、附加邮箱和用户数据将直接永久删除，不再进入已审计的保留期。',
    syncDeleteConfirm: '确定开启永久删除吗？删除的数据将绕过垃圾箱保留期，且无法恢复。',
    multipleEmail: '多号模式',
    ...
    aiPrivacyDisclosure: '启用后，仅对匹配发件人/域名的邮件，将主题和最多 6,000 字符正文发送给 Cloudflare Workers AI 处理。若不接受该数据路径，请保持关闭。',
    oss: '对象存储',
    osDomain: '访问域名',
